 ...
 * @author willex
 */
public class RListaClientes{
    
    public RListaClientes(){ }
    
    public void runClienteParametro() {
        try {
            String master = System.getProperty("user.dir") + "/src/com/siv/reportes/RClientes.jasper";
            if (master == null) {
    ...
    private class UsarReporte implements JRDataSource{
        ...
        public Object getFieldValue(JRField jrf) throws JRException {
            ...
            if("DNI".equalsIgnoreCase(jrf.getName())) { valor = lta.get(indice).getDni() ;}
                ...
                valor = lta.get(indice).getTelefono()+" / "+lta.get(indice).getCelular();
            }
